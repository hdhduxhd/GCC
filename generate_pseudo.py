...
#     parser.add_argument('--model-file', type=str, default='./logs/Domain1/20241229_050509.845609/checkpoint_195.pth.tar')
    ...
    if not osp.exists('./initial_pseudo'):
        os.mkdir('./initial_pseudo')
    
    if args.dataset=="Domain3":
        np.savez('./initial_pseudo/pseudolabel_D3_'+time, pseudo_label_dic, uncertain_dic, proto_pseudo_dic, prob_dic,
        ...
        np.savez('./initial_pseudo/pseudolabel_D2_'+time, pseudo_label_dic, uncertain_dic, proto_pseudo_dic, prob_dic,
                         distance_0_obj_dic, distance_0_bck_dic, distance_1_obj_dic, distance_1_bck_dic,
                         centroid_0_obj_dic, centroid_0_bck_dic, centroid_1_obj_dic, centroid_1_bck_dic
                         )
    elif args.dataset=="Domain1":
        np.savez('./initial_pseudo/pseudolabel_D1_'+time, pseudo_label_dic, uncertain_dic, proto_pseudo_dic, prob_dic,
                         distance_0_obj_dic, distance_0_bck_dic, distance_1_obj_dic, distance_1_bck_dic,
                         centroid_0_obj_dic, centroid_0_bck_dic, centroid_1_obj_dic, centroid_1_bck_dic
                         )
    elif args.dataset=="Domain4":
        np.savez('./initial_pseudo/pseudolabel_D4_'+time, pseudo_label_dic, uncertain_dic, proto_pseudo_dic, prob_dic,
                         distance_0_obj_dic, distance_0_bck_dic, distance_1_obj_dic, distance_1_bck_dic,
                         centroid_0_obj_dic, centroid_0_bck_dic, centroid_1_obj_dic, centroid_1_bck_dic
                         )
